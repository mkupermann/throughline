> Historical design document (German). The current architecture reference is [architecture.md](architecture.md).
...
**Option 2: Custom the web UI-App (mehr Kontrolle)**

```bash
pip install -e .
throughline serve --port 8787
```
