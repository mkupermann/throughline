...
PM_TABLES = {
    ...
    "pm_assignments": {"id", "pm_project_id", "team_id", "role_id", "member_id", "ai_tool", "ai_model"},
    "pm_tasks": {
        "id",
        "pm_project_id",
        "team_id",
    ...
    "pm_ai_providers": {"id", "name", "provider_type", "base_url", "api_key", "custom_models", "enabled"},
}
