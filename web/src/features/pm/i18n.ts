...
const de = {
  ...
  dashboard: {
    ...
    catalogTeams: "Teams",
    catalogTeamsTitle: "Teams werden im Projekt-Cockpit verwaltet",
  ...
  forms: {
    ...
    aiToolPlaceholder: "z. B. aider, claude, vibe",
    aiModelLabel: "KI-Modell",
    aiModelPlaceholder: "z. B. ollama_chat/qwen3-coder:30b",
...
const en: typeof de = {
  ...
  dashboard: {
    ...
    catalogTeams: "Teams",
    catalogTeamsTitle: "Teams are managed in the project cockpit",
  ...
  forms: {
    ...
    aiToolLabel: "AI tool",
    aiToolPlaceholder: "e.g. aider, claude, vibe",
    aiModelLabel: "AI model",
    aiModelPlaceholder: "e.g. ollama_chat/qwen3-coder:30b",
    budgetLabel: "Token budget",
    skillsLabel: "Skills",
